...
public class DBIForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        consultarSN("http://144.22.35.197/ConsultarSN.php");
        consultarApellido("http://144.22.35.197/fetchApellido.php");
    ...
    private void fetchNombre(String URL){
        RequestQueue requestQueue = Volley.newRequestQueue(DBIForm.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DBIForm.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Nullable
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("")){
                    ...
                    Toast.makeText(DBIForm.this, "No SN registered", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(!response.equals("")){
                  ...
                  //  Toast.makeText(this, "Error al consultar apellido", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
    ...
    public void guardarNAN(){
        SharedPreferences pf =getSharedPreferences("NAN",MODE_PRIVATE);
        SharedPreferences.Editor editor = pf.edit();
        editor = editor.putString("Nombre",nombre);
        editor = editor.putString("Apellido",apellido);
        editor = editor.putString("Numero",num);
        editor.commit();
    }
